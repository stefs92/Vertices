...
def runsim(initial_res = 8, final_res = 20, res_step = 2,halo_size = 0.3, W = 1.0, L = 5.0, l = 1.0):
    ...
    sim.solve()
    #ps.colorplot(sim.v_gradient,sim.res-1,'Gradient',sim.L)
    ...
    ps.colorplot(sim.v_gradient,sim.res-2,'Gradient',sim.L)
    #print('n_v')
    #print(sim.n_v)
    
    for i in range(5):
        sim.solve()
        #ps.colorplot(sim.v_gradient,sim.res-2,'Gradient')
